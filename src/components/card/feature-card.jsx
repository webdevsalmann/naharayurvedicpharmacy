...
export default function FeatureCard({ data: { slug, category, name, indication, ingredients, pricing } }) {
    return (
        <div className='relative size-fit rounded-md hover:border-primary border hover:shadow-lg hover:-translate-y-1 transition-all overflow-hidden group'>
            <Link className='relative grid md:grid-cols-2' href={`/shop/${slug}`}>
                ...
                <div className="p-2 bg-background size-full flex flex-col gap-1">
                    <div className="md:flex-1">
                        ...
                        <div className="mt-1 flex gap-xs text-muted-foreground">
                            <Cross className="mt-px size-base shrink-0" />
                            <div className="text-xs md:text-sm leading-4  line-clamp-2">
                                {indication ? indication : "Indication"}
                            </div>
                        </div>

                        <div className="mt-1 flex gap-xs text-muted-foreground">
                            <Sprout className="mt-px size-base shrink-0" />
                            <div className="text-xs md:text-sm leading-4 line-clamp-2">
